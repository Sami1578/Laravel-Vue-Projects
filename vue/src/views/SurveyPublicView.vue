<template>
    <div class="py-5 px-89">
        ...
        <form @submit.prevent="submitSurvey" v-else class="container mx-auto">
            ...
            <div 
            v-if="surveyFinished"
            class="my-4 py-8 px-6 bg-emerald-400 text-white w-[600px] mx-auto">
                ...
                type="button"
                class="inline-flex justify-center py-2 px-4 border-transparent shadow-sm text-sm
