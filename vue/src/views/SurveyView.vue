                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            ...
                            autocomplete="surver_description"
                            class="
                            shadow-sm
                            focus:ring-indigo-500 focus:border-indigo-500
                            mt-1
                    ...
                    <!--- Expire Date -->
                    <div>
                        <label for="expire_datte" class="block text-sm font-medium text-gray-700">
                            Expire Date
                        </label>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="statue" id="status"
...
function deleteSurvey(){
    if(
        confirm("Are you sure you want to delete this Survey Completely. Please Confirm?")
    ){
