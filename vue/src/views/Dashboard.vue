<template>
    <PageComponent title="Dashboard">
        ...
        >
            ...
            class="row-span-2 lg:order-1 order-3 bg-white shadow-md animate-fade-in-down p-4"
            >
                <h3 class="text-2xl font-semibold">Latest Survey</h3>
                <img 
                :src="data.latestSurvey.image_url"
                class="w-[240px] mx-auto my-4"
                alt=""
                >
            ...
            <div 
            class="row-span-2 lg:order-3 order-4 bg-white shadow-md animate-fade-in-down p-3"
